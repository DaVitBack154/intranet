...
export default function ReportProcess() {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      try {
        let itResp = await axios.get(process.env.REACT_APP_SERVER_ENDPOINT + '/api/report/repair', {
          params: params,
        ...
        let ratingResp = await axios.get(process.env.REACT_APP_SERVER_ENDPOINT + '/api/report/rating', {
          params: params,
          withCredentials: true
        })
        ...
        let topicResp = await axios.get(process.env.REACT_APP_SERVER_ENDPOINT + '/api/report/topic', {
          params: params,
          withCredentials: true
        })
        ...
        let commentResp = await axios.get(process.env.REACT_APP_SERVER_ENDPOINT + '/api/report/comment-rating', {
          params: params,
          withCredentials: true
        })
                  ...
                  {ratingData.map((item) => (
                    <div className="rating-item" key={item.id}>
                      <div className="admin-img">
                        <img src={process.env.REACT_APP_SERVER_ENDPOINT+'/public/image/repair/' + item.image}></img>
                      </div>
